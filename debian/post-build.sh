...
function fixup_fstab()
{
    ...
    # Remove oem/userdata when using simplified partition layout (boot+rootfs only)
    del_part "/dev/disk/by-partlabel/oem" "/oem"
    del_part "/dev/disk/by-partlabel/userdata" "/userdata"
